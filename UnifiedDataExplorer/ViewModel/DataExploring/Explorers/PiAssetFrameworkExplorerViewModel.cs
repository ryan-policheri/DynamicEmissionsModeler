...
{
    public class PiAssetFrameworkExplorerViewModel : ExplorerViewModel
    {
        ...
        public PiAssetFrameworkExplorerViewModel(DataSourceServiceFactory clientFactory, RobustViewModelDependencies facade) : base(facade)
        {
        ...
        public override string Header => "PI Asset Framework Explorer";
        public override string HeaderDetail => "Navigate to a PI Asset Framework (AF) dataset";
        ...
        private void PublishOpenViewModelEvent(ServerDatabaseAssetWrapper model, string verb)
        {
            ...
            {
                Sender = this,
                SenderTypeName = nameof(PiAssetFrameworkExplorerViewModel),
