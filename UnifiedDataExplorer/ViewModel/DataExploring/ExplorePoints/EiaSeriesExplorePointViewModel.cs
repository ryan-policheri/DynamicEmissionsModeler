...
{
    public class EiaSeriesExplorePointViewModel : ExplorePointViewModel
    {
        ...
        public EiaSeriesExplorePointViewModel(DataSourceServiceFactory clientFactory, DataFileProvider dataFileProvider, ExcelExportService exporter, IMessageHub messageHub) : base(messageHub)
        {
        ...
        public string ValueUnit
        {
            ...
            private set { SetField(ref _valueUnit, value); }
        }
