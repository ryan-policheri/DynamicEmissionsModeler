...
namespace UIowaBuildingsServices
{
    public class ReportingService
    {
        ...
        public async Task<CampusSnapshot> GenerateCampusSnapshot(HourlyEmissionsReportParameters parameters)
        {
            ...
            if(endDateTime.LocalDateTime > DateTime.Now) endDateTime = new DateTimeOffset(new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.Day, DateTime.Now.Hour - 1, 0, 0, DateTimeKind.Local), TimeZones.GetCentralTimeOffset(parameters.StartDateInLocalTime.Date));
