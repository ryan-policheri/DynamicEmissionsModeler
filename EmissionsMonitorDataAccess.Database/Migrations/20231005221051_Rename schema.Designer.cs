...
namespace EmissionsMonitorDataAccess.Database.Migrations
{
    ...
    [Migration("20231005221051_Rename schema")]
...
#pragma warning disable 612, 618
            modelBuilder
                .HasDefaultSchema("EmissionsMonitor")
            ...
            modelBuilder.Entity("EmissionsMonitorModel.DataSources.DataSourceBase", b =>
                {
                    ...
                    b.ToTable("DATA_SOURCE", "EmissionsMonitor");
                });
            ...
            modelBuilder.Entity("EmissionsMonitorModel.Experiments.DailyCarbonTrend.DailyCarbonExperiment", b =>
                {
                    ...
                    b.ToTable("DAILY_CARBON_EXPERIMENT", "EmissionsMonitor");
                });
            ...
            modelBuilder.Entity("EmissionsMonitorModel.Experiments.DailyCarbonTrend.DailyCarbonExperimentRecord", b =>
                {
                    ...
                    b.ToTable("DAILY_CARBON_EXPERIMENT_RECORD", "EmissionsMonitor");
                });
            ...
            modelBuilder.Entity("EmissionsMonitorModel.Experiments.IndStudyExp.IndStudyExperiment", b =>
                {
                    ...
                    b.ToTable("IND_STUDY_EXPERIMENT", "EmissionsMonitor");
                });
            ...
            modelBuilder.Entity("EmissionsMonitorModel.Experiments.IndStudyExp.IndStudyExperimentRecord", b =>
                {
                    ...
                    b.ToTable("IND_STUDY_EXPERIMENT_RECORD", "EmissionsMonitor");
                });

            modelBuilder.Entity("EmissionsMonitorModel.Experiments.NodeInspect.NodeInspectExperiment", b =>
                {
                    b.Property<int>("ExperimentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("NODE_INSPECT_EXPERIMENT", "EmissionsMonitor");
                });

            modelBuilder.Entity("EmissionsMonitorModel.Experiments.NodeInspect.NodeInspectExperimentRecord", b =>
                {
                    b.Property<int>("ExperimentId")
                        .HasColumnType("int");
                    ...
                    b.Property<double>("CO2EmissionsInKilograms")
                        .HasColumnType("float");

                    b.Property<double>("CO2EmissionsPerDefaultProductUnit")
                        .HasColumnType("float");

                    b.Property<double>("FuelCostInDollars")
                        .HasColumnType("float");

                    b.Property<double>("FuelCostPerDefaultProductUnit")
                        .HasColumnType("float");

                    b.Property<string>("ProductDefaultUnit")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<double>("ProductTotalInDefaultUnit")
                        .HasColumnType("float");

                    b.HasKey("ExperimentId", "Timestamp");

                    b.ToTable("NODE_INSPECT_EXPERIMENT_RECORD", "EmissionsMonitor");
                });
            ...
            modelBuilder.Entity("EmissionsMonitorModel.VirtualFileSystem.Folder", b =>
                {
                    ...
                    b.ToTable("FOLDER", "EmissionsMonitor");
                });
            ...
            modelBuilder.Entity("EmissionsMonitorModel.VirtualFileSystem.SaveItem", b =>
                {
                    ...
                    b.ToTable("SAVE_ITEM", "EmissionsMonitor");
            ...
            modelBuilder.Entity("EmissionsMonitorModel.Experiments.NodeInspect.NodeInspectExperimentRecord", b =>
                {
                    b.HasOne("EmissionsMonitorModel.Experiments.NodeInspect.NodeInspectExperiment", "Experiment")
                        .WithMany("ExperimentRecords")
                        .HasForeignKey("ExperimentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
